...
public class WikiTest {
	...
	//--------------------USER STORY 4-----------------------------------------
		/*
		 * As a user I want to
		 * Access different topics(categories) of Wikipedea's encyclopedia so that I can
		 * Browse articles under each category.	 
		 */
		//------------------Scenario 4-1-------------------------------------------
		/*
		 * Given that I'm on the Wikipedia main page
		 * When I try to change the category to Mathematics
		 * Then I should see the return of the page with the category Mathematics
		 */
	@Test
	public void testCategoryMathematics() throws Exception {
		...
		/*
		 * Given that I'm on the Wikipedia main page
		 * When I try to change the category to Arts from the Wikipedia main page
		 * Then I should see the return of the page with the category Arts
		 */
	@Test
	public void testCategoryArts() throws Exception {
		...
		/*
		 * Given that I'm on the Wikipedia main page
		 * When I try to change the category to Society 
		 * Then I should see the return of the page with the category Society
		 */
	@Test
	public void testCategorySociety() throws Exception {
		...
		/*
		 * Given that I'm on the Wikipedia main page
		 * When I try to change the category to Science and then change to the category Society
		 * Then I should see the return of the page with the category Society
		 */
	@Test
	  public void testCategoryScienceToSociety() throws Exception {
		...
		/*
		 * Given that I'm on the Wikipedia main page
		 * When I try to access all of the portals  
		 * Then I should see the return of the page with the Portal:Contents/Portals
		 */
	@Test
